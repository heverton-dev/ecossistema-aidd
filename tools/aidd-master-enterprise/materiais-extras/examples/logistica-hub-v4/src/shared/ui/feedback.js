// =========================================================================
// AIDD DESIGN SYSTEM — FEEDBACK UI ENGINE (TOASTS, MODALS & DIALOGS)
// =========================================================================
(function() {
    // 1. Injetar CSS do Design System se não estiver presente
    if (!document.getElementById('aidd-ds-feedback-style')) {
        const style = document.createElement('style');
        style.id = 'aidd-ds-feedback-style';
        style.textContent = `
            /* SCROLLBAR 4PX UNIVERSAL */
            * {
            ...
            /* BOTÕES EM LINHA ÚNICA (SEM QUEBRA DE LINHA) */
