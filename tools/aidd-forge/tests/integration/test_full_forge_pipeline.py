...
EXPECTED_GATES = (
    ...
    "G_DETERMINISMO_LEI_1.py", "G_ESTRUTURA_AST.py", "G_HARNESS_COMPAT.py",
    "G_INJECT.py", "G_PERFORMANCE.py", "G_QUARTETO_SINE_QUA_NON.py",
    "G_SAIDA_BINARIA.py", "G_STACK_PADRAO_OURO.py", "G_TESTES_REAIS.py",
)
