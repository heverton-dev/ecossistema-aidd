...
import assinatura_manifesto  # noqa: E402
...
# ---------------------------------------------------------------------------
# Assinatura Ed25519 do Manifesto Canônico (manifest-assinado-ed25519)
# ---------------------------------------------------------------------------
...
def test_ataque_reescreve_arquivo_e_hash_mas_manifesto_assinado_recusa(tmp_path):
    ...
    hash_malicioso = hashlib.sha256(arquivo_mcp.read_bytes()).hexdigest()
