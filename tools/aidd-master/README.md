...
- **Núcleo Compartilhado Único:** `src/core/` é sincronizado a partir da fonte única `componentes/compartilhado/src-core/` — zero duplicação silenciosa com o AIDD Enterprise.
