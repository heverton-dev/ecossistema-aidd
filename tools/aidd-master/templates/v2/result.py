...
"""
=============================================================================
AIDD v5.1 Enterprise — PADRÃO RESULTADO MONÁDICO (Result Pattern via returns)
=============================================================================
Substitui a implementação caseira de Result Monad pela biblioteca testada
e mantida 'returns' (dry-python). Elimina exceções soltas e fornece retornos
previsíveis para serviços de domínio, APIs, pipelines e chamadas MCP.
=============================================================================
"""
