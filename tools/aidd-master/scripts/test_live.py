__test__ = False  # Previne coleta automatica pelo pytest (este e um script manual de verificacao e2e)
...
def main():
    ...
    try:
        ...
        print(f'[ERRO] Autenticacao JWT (/api/auth/login) -> {e}')
    ...
    try:
        ...
        print(f'[ERRO] Webhook Studio Simulator           -> {e}')
