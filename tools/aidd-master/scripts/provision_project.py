...
def provision(project_desc, base_dir=None):
    ...
    if os.path.exists(templates_dir):
        for f in ['database.py', 'events.py', 'openapi.py', 'webhooks.py', 'security.py', 'token_revocation.py', 'mcp_server.py', 'mcp_repository.py', 'cqrs.py', 'result.py', 'repositories.py', 'circuit_breaker.py', 'saga.py']:
