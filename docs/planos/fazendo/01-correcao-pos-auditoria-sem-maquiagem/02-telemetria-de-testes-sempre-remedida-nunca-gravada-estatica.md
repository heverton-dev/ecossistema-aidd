# Item 2 — Telemetria de testes sempre remedida, nunca gravada estatica
...
> **Modelo sugerido:** Claude Haiku · Antigravity Gemini 3.1 pro · MiMo mimo-v2.5 (script determinístico de regeneração + hook, sem julgamento)
...
```
Voce vai implementar o Item 2: Telemetria de testes sempre remedida, nunca gravada estatica.
...
```
You are going to implement Item 2: Telemetria de testes sempre remedida, nunca gravada estatica.
