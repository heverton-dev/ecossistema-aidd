...
| # | Item | Documento |
|---|---|---|
| 1 | outbox-claim-atomico-retry-e-dead-letter | `01-outbox-claim-atomico.md` |
| 2 | escritor-atomico-compartilhado-e-migracao-fs | `02-escritor-atomico-compartilhado.md` |
| 3 | maquina-estados-pipeline-generator-e-resume | `03-maquina-estados-pipeline.md` |
| 4 | retry-backoff-sqlite-busy-e-pool-explicito | `04-retry-backoff-sqlite.md` |
| 5 | fila-unica-revalidacao-read-model-cache | `05-fila-unica-revalidacao.md` |
| 6 | registry-writers-com-lock-e-rename-atomico | `06-registry-writers-lock.md` |
| 7 | checkpoint-persistencia-result-ops-deploy | `07-checkpoint-persistencia-result.md` |
| 8 | journal-recuperacao-pos-crash-multi-arquivo | `08-journal-recuperacao-crash.md` |
