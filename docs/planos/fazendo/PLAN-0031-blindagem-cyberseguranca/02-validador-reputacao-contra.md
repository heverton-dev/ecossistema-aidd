...
```
Voce vai implementar o Item 2: Validador reputacao contra alucinacao pacotes.
...
```
You are going to implement Item 2: Validador reputacao contra alucinacao pacotes.
