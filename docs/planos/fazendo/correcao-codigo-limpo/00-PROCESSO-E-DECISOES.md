...
|---|---|---|---|
| 1 | Trocar except Exception generico por excecoes especificas nas 5 ferramentas | 🔶 Segunda fatia concluida em 2026-09-08 — aidd-generator/aidd-ops/aidd-forge 100% revisados; aidd-enterprise/aidd-master com core+gates+varios arquivos src/core/ feitos, resto (templates/, alguns core/ com razao documentada) pendente | `01-trocar-except-exception-generico-por-excecoes-especificas-nas-5-ferramentas.md` |
