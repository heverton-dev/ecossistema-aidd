...
| # | Item | Documento |
|---|---|---|
| 1 | testes-conteudo-sha256-injector-enterprise | `01-testes-conteudo-sha256.md` |
| 2 | testes-exatidao-sizing-ops-fixtures-ouro | `02-testes-exatidao-sizing.md` |
| 3 | testes-resiliencia-outbox-crash-pos-emit-dead-letter | `03-testes-resiliencia-outbox.md` |
| 4 | eliminar-timesleep-injetar-relogio-cqrs-polling-deadline | `04-eliminar-timesleep-injetar.md` |
| 5 | portas-efemeras-testes-integracao-servidor | `05-portas-efemeras-testes.md` |
| 6 | g-testes-reais-v2-junitxml-orcamento-skipped | `06-g-testes-reais.md` |
| 7 | testes-contrato-rls-e-wal-pragmas | `07-testes-contrato-rls.md` |
| 8 | teste-contrato-sizing-para-helm-values | `08-teste-contrato-sizing.md` |
| 9 | gate-g-mutacao-mutmut-regras-exatas | `09-gate-g-mutacao.md` |
| 10 | politica-warnings-pytest-deprecations | `10-politica-warnings-pytest.md` |
...
|---|---|---|---|
| 1 | testes-conteudo-sha256-injector-enterprise | ✅ Concluido | `01-testes-conteudo-sha256.md` |
| 2 | testes-exatidao-sizing-ops-fixtures-ouro | ✅ Concluido | `02-testes-exatidao-sizing.md` |
| 3 | testes-resiliencia-outbox-crash-pos-emit-dead-letter | ✅ Concluido | `03-testes-resiliencia-outbox.md` |
| 4 | eliminar-timesleep-injetar-relogio-cqrs-polling-deadline | ⏳ Rascunho — parte ja implementada (ver auditoria) | `04-eliminar-timesleep-injetar.md` |
| 5 | portas-efemeras-testes-integracao-servidor | ✅ Concluido | `05-portas-efemeras-testes.md` |
| 6 | g-testes-reais-v2-junitxml-orcamento-skipped | ✅ Concluido | `06-g-testes-reais.md` |
| 7 | testes-contrato-rls-e-wal-pragmas | ⏳ Rascunho gerado, aguardando aprovacao | `07-testes-contrato-rls.md` |
| 8 | teste-contrato-sizing-para-helm-values | ✅ Concluido | `08-teste-contrato-sizing.md` |
| 9 | gate-g-mutacao-mutmut-regras-exatas | ⏳ Rascunho gerado, aguardando aprovacao | `09-gate-g-mutacao.md` |
| 10 | politica-warnings-pytest-deprecations | ⏳ Rascunho gerado, aguardando aprovacao | `10-politica-warnings-pytest.md` |
