...
| # | Item | Documento |
|---|---|---|
| 1 | Reativar G_ARQUITETURA_DELIVERABLE corrigindo 212 violacoes SQL-fora-infra nos templates | `01-reativar-g-arquitetura.md` |
| 2 | Adicionar testes reais as 2 entregas sem cobertura (enterprise-suite-v4, logistica-hub-v4) | `02-adicionar-testes-reais.md` |
| 3 | Quebrar funcoes gigantes get_swagger_html (736 linhas) e compose_suite (277/273) | `03-quebrar-funcoes-gigantes.md` |
| 4 | Documentar e eliminar divergencia master-enterprise (3 src/core + 6 scripts + mcp/) | `04-documentar-eliminar-divergencia.md` |
| 5 | Corrigir drift de documentacao do G_HONESTIDADE_ROTULO (AGENTS.md + termos_proibidos_marketing.json) | `05-corrigir-drift-documentacao.md` |
| 6 | Reduzir timeout do G_TESTES_REAIS no audit completo | `06-reduzir-timeout-g-testes.md` |
...
| 5 | Corrigir drift de documentacao do G_HONESTIDADE_ROTULO (AGENTS.md + termos_proibidos_marketing.json) | 🔶 Em execucao | 6.0 | 10.0 | [Pendente - preencher somente apos o fechamento real deste item/iniciativa, via o mesmo mecanismo que mediu a Nota Atual] | `05-corrigir-drift-documentacao.md` |
| 6 | Reduzir timeout do G_TESTES_REAIS no audit completo | 🔶 Em execucao | 5.0 | 9.0 | [Pendente - preencher somente apos o fechamento real deste item/iniciativa, via o mesmo mecanismo que mediu a Nota Atual] | `06-reduzir-timeout-g-testes.md` |
