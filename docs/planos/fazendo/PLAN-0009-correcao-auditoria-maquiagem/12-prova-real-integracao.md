# Item 12 — Prova real de integracao multi-ferramenta no teste integrado
...
> **Status:** [RASCUNHO — Aguardando Aprovacao Humana — escolha do elo depende do usuário]
> **Modelo sugerido:** Claude Opus · Antigravity Gemini 3.8 · MiMo mimo-v2.5-pro (decisão arquitetural: qual ponto de integração é o mais valioso e viável primeiro)
...
```
Voce vai implementar o Item 12: Prova real de integracao multi-ferramenta no teste integrado.
...
```
You are going to implement Item 12: Prova real de integracao multi-ferramenta no teste integrado.
