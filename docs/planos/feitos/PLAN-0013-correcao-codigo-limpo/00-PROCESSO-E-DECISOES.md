...
| # | Item | Documento |
|---|---|---|
| 1 | Trocar except Exception generico por excecoes especificas nas 5 ferramentas | `01-trocar-except-exception.md` |
| 2 | Eliminar except sem tipo (bare except) em aidd-enterprise, aidd-master e aidd-generator | `02-eliminar-except-tipo.md` |
| 3 | Dividir metodos com mais de 100 linhas nas classes grandes do aidd-generator e aidd-ops | `03-dividir-metodos-mais.md` |
| 4 | Dividir run_all_checks (G_SEGURANCA.py) em funcoes menores por camada de responsabilidade | `04-dividir-run-all.md` |
| 5 | Remover import duplicado (import subprocess repetido) em G_SEGURANCA.py | `05-remover-import-duplicado.md` |
| 6 | Substituir comentarios-divisorios de secao por decomposicao real em funcao onde o mesmo padrao se repete | `06-substituir-comentarios-divisorios.md` |
| 7 | Definir e documentar convencao unica de nomenclatura PT-BR e ingles entre as ferramentas | `07-definir-documentar-convencao.md` |
| 8 | Registrar ranking de limpeza por ferramenta atualizado com todas as metricas (sem acao corretiva) | `08-registrar-ranking-limpeza.md` |
...
|---|---|---|---|
| 1 | Trocar except Exception generico por excecoes especificas nas 5 ferramentas | ✅ Concluido (auditado por reproducao real em 2026-09-09) — aidd-generator/aidd-ops/aidd-forge 100% revisados; aidd-enterprise/aidd-master com src/core, templates/core e templates/v2 100% revisados (toda ocorrencia restante e deliberadamente ampla, com razao documentada); decisao de arquitetura sobre excecao de banco multi-motor (SQLite/Postgres) tomada e aplicada; pendencia menor fora de escopo: src/modules/ e tests/ das 5 ferramentas nunca auditados | `01-trocar-except-exception.md` |
| 2 | Eliminar except sem tipo (bare except) em aidd-enterprise, aidd-master e aidd-generator | ✅ Concluido (auditado por reproducao real em 2026-09-08) | `02-eliminar-except-tipo.md` |
| 3 | Dividir metodos com mais de 100 linhas nas classes grandes do aidd-generator e aidd-ops | ✅ Concluido (6 de 6 metodos, auditado por reproducao real em 2026-09-08) | `03-dividir-metodos-mais.md` |
| 4 | Dividir run_all_checks (G_SEGURANCA.py) em funcoes menores por camada de responsabilidade | ✅ Concluido (auditado por reproducao real em 2026-09-08 — saida e exit code identicos antes/depois, nas 4 copias) | `04-dividir-run-all.md` |
| 5 | Remover import duplicado (import subprocess repetido) em G_SEGURANCA.py | ✅ Concluido (auditado por reproducao real em 2026-09-08) | `05-remover-import-duplicado.md` |
| 6 | Substituir comentarios-divisorios de secao por decomposicao real em funcao onde o mesmo padrao se repete | ✅ Concluido (censo real confirma zero ocorrencias remanescentes, 2026-09-08) | `06-substituir-comentarios-divisorios.md` |
| 7 | Definir e documentar convencao unica de nomenclatura PT-BR e ingles entre as ferramentas | ✅ Concluido em 2026-09-09 — decisao colhida do usuario (formalizar padrao observado) e documentada em AGENTS.md secao 4.1 | `07-definir-documentar-convencao.md` |
| 8 | Registrar ranking de limpeza por ferramenta atualizado com todas as metricas (sem acao corretiva) | ✅ Concluido (tabela registrada em 2026-09-08; nota de atualizacao pos-itens 3/4 adicionada em sessao posterior) | `08-registrar-ranking-limpeza.md` |
