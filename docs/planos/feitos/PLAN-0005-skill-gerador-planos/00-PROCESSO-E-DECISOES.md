...
| # | Item | Documento |
|---|---|---|
| 1 | Criar a skill compartilhada `planos-auditoria-runner` (nome sugerido) em `componentes/compartilhado/skills/` | `01-criar-skill-planos.md` |
...
|---|---|---|---|
| 1 | Criar skill `planos-auditoria-runner` | ✅ Concluído | `01-criar-skill-planos.md` |
