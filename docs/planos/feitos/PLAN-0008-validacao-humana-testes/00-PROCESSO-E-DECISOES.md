...
|---|---|---|---|---|
| **1** | AIDD Forge | `C:\Users\trcnologia\Desktop\teste-isolado-aidd-forge` | Governança, pre-commit hook e 7 gates instalados no projeto alvo | `01-teste-isolado-aidd.md` |
| **2** | AIDD Generator | `C:\Users\trcnologia\Desktop\teste-isolado-aidd-generator` | Software construído em 8 fases com frontend web rodando | `02-teste-isolado-aidd.md` |
| **3** | AIDD Master | `C:\Users\trcnologia\Desktop\teste-isolado-aidd-master` | Monólito modular com Swagger Studio interativo no browser | `03-teste-isolado-aidd.md` |
| **4** | AIDD Enterprise | `C:\Users\trcnologia\Desktop\teste-isolado-aidd-enterprise` | Componentes injetados com selo de integridade SHA-256 e Zero-Trust | `04-teste-isolado-aidd.md` |
| **5** | AIDD Ops | `C:\Users\trcnologia\Desktop\teste-isolado-aidd-ops` | Sizing de VPS, Docker Compose, Preflight HTTP real e simulador de deploy | `05-teste-isolado-aidd.md` |
| **6** | Integrado E2E | `C:\Users\trcnologia\Desktop\teste-integrado-ecossistema-aidd` | O ciclo de vida completo unificado das 5 ferramentas com frontend | `06-teste-integrado-ciclo.md` |
...
|---|---|:---:|---|
| 1. AIDD Forge | ✅ Concluído & Aprovado | Aprovado | `01-teste-isolado-aidd.md` |
| 2. AIDD Generator | ✅ Concluído & Aprovado | Aprovado | `02-teste-isolado-aidd.md` |
| 3. AIDD Master | ✅ Concluído & Aprovado | Aprovado | `03-teste-isolado-aidd.md` |
| 4. AIDD Enterprise | ✅ Concluído & Aprovado | Aprovado | `04-teste-isolado-aidd.md` |
| 5. AIDD Ops | ✅ Concluído & Aprovado | Aprovado | `05-teste-isolado-aidd.md` |
| 6. Integrado E2E | ✅ Concluído & Homologado | Aprovado (Nota 9.56) | `06-teste-integrado-ciclo.md` |
