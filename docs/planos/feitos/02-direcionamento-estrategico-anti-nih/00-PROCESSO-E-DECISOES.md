...
| 10 | Migrar CLI de cada ferramenta de argparse para o padrão do ecossistema.py (Onda 4 remanescente) | `10-migrar-cli-de-cada-ferramenta-de-argparse-para-o-padrao-do-ecossistemapy-onda-4-remanescente.md` |
| 11 | Adotar instructor e terminar migração MCP SDK no núcleo compartilhado (Onda 5 remanescente) | `11-adotar-instructor-e-terminar-migracao-mcp-sdk-no-nucleo-compartilhado-onda-5-remanescente.md` |
...
|---|---|---|---|
| 1 | Inventario do que fica vs o que troca por ferramenta (o trabalho que continua de pe) | ✅ **Verificado em 2026-09-09** — tabela publicada em `docs/features/inventario-o-que-fica-vs-o-que-troca-por-ferramenta.md`, rastreabilidade mantida. Nenhuma mudança necessária. | `01-inventario-do-que-fica-vs-o-que-troca-por-ferramenta-o-trabalho-que-continua-de-pe.md` |
