# Item 2 — Corrigir o que a causa raiz apontar no motor ou nos testes
...
```
Voce vai implementar o Item 2: Corrigir o que a causa raiz apontar no motor ou nos testes.
...
```
You are going to implement Item 2: Corrigir o que a causa raiz apontar no motor ou nos testes.
