# Item 15 — requirements.txt do app gerado pelo generator dessincronizado do código real
...
> **Modelo sugerido:** Claude Haiku · Antigravity Gemini 3.1 pro · MiMo mimo-v2.5 (correção pontual: extrair imports reais e sincronizar manifest)
...
- Bug reproduzido antes da correção (não assumir, confirmar).
- Correção testada de ponta a ponta: projeto gerado sobe com as dependências reais instaladas.
...
```
Você vai implementar o Item 15: requirements.txt do app gerado pelo generator dessincronizado do código real.
...
```
You are going to implement Item 15: requirements.txt of the generator's output app is out of sync with the real generated code.
