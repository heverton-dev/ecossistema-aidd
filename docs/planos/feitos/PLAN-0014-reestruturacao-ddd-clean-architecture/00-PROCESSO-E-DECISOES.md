...
| # | Item | Documento |
|---|---|---|
| 1 | fechar-nucleo-compartilhado-e-honestidade-rotulos | `01-fechar-nucleo-compartilhado.md` |
| 2 | unificar-orquestradores-generator-e-ops | `02-unificar-orquestradores-generator.md` |
| 3 | extrair-camada-aplicacao-dos-clis-master-enterprise | `03-extrair-camada-aplicacao.md` |
| 4 | remover-hacks-syspath-no-generator | `04-remover-hacks-syspath.md` |
| 5 | contrato-formal-schema-ops-para-master-enterprise | `05-contrato-formal-schema.md` |
| 6 | novo-molde-fatia-vertical-ddd-clean-master | `06-novo-molde-fatia.md` |
| 7 | gate-g-arquitetura-deliverable | `07-gate-g-arquitetura.md` |
| 8 | atualizar-scaffolders-master-enterprise-cookiecutter | `08-atualizar-scaffolders-master.md` |
| 9 | trazer-deliverables-generator-perimetro-gates | `09-trazer-deliverables-generator.md` |
| 10 | teste-integracao-helm-aidd-ops | `10-teste-integracao-helm.md` |
...
|---|---|---|---|
| 1 | fechar-nucleo-compartilhado-e-honestidade-rotulos | ✅ Concluido — mesclado em main (6c8a427), auditado por reproducao real | `01-fechar-nucleo-compartilhado.md` |
| 2 | unificar-orquestradores-generator-e-ops | ✅ Concluido — mesclado em main (6c8a427), auditado por reproducao real | `02-unificar-orquestradores-generator.md` |
| 3 | extrair-camada-aplicacao-dos-clis-master-enterprise | ✅ Concluido — mesclado em main (6c8a427), auditado por reproducao real | `03-extrair-camada-aplicacao.md` |
| 4 | remover-hacks-syspath-no-generator | ✅ Concluido (escopo reduzido, aprovado pelo usuario) — mesclado em main (710a8bc), auditado por reproducao real | `04-remover-hacks-syspath.md` |
| 5 | contrato-formal-schema-ops-para-master-enterprise | ✅ Concluido — mesclado em main (6c8a427), auditado por reproducao real | `05-contrato-formal-schema.md` |
| 6 | novo-molde-fatia-vertical-ddd-clean-master | ✅ Concluido — corrigido, mesclado em main (6c8a427), auditado por reproducao real | `06-novo-molde-fatia.md` |
| 7 | gate-g-arquitetura-deliverable | ✅ Concluido — mesclado em main (6c8a427), auditado por reproducao real | `07-gate-g-arquitetura.md` |
| 8 | atualizar-scaffolders-master-enterprise-cookiecutter | ✅ Concluido — mesclado em main (710a8bc), auditado por reproducao real | `08-atualizar-scaffolders-master.md` |
| 9 | trazer-deliverables-generator-perimetro-gates | ✅ Concluido — mesclado em main (4cb3f88), auditado por reproducao real | `09-trazer-deliverables-generator.md` |
| 10 | teste-integracao-helm-aidd-ops | ✅ Concluido — mesclado em main (6c8a427), auditado por reproducao real | `10-teste-integracao-helm.md` |
