# Item 3 — Estender G_TESTES_REAIS para cobrir tambem componentes
...
```
Voce vai implementar o Item 3: Estender G_TESTES_REAIS para cobrir tambem componentes.
...
```
You are going to implement Item 3: Estender G_TESTES_REAIS para cobrir tambem componentes.
