...
| # | Item | Documento |
|---|---|---|
| 1 | sandbox-nivel-1-subprocess-env-minimo-fase-08 | `01-sandbox-nivel-1-subprocess-env-minimo-fase-08.md` |
| 2 | gate-owasp-sobre-output-fase-08 | `02-gate-owasp-sobre-output-fase-08.md` |
| 3 | corrigir-interpolacao-sql-set-tenant-pg | `03-corrigir-interpolacao-sql-set-tenant-pg.md` |
| 4 | pin-exato-e-hashes-requirements-lockfile | `04-pin-exato-e-hashes-requirements-lockfile.md` |
| 5 | manifest-assinado-ed25519-componentes-enterprise | `05-manifest-assinado-ed25519-componentes-enterprise.md` |
| 6 | jwt-hardening-segredo-prod-exp-obrigatorio | `06-jwt-hardening-segredo-prod-exp-obrigatorio.md` |
| 7 | hash-artefatos-skills-mcps-dependencias-externas | `07-hash-artefatos-skills-mcps-dependencias-externas.md` |
| 8 | mcp-defensivo-cap-limite-e-env-denylist | `08-mcp-defensivo-cap-limite-e-env-denylist.md` |
| 9 | rls-fail-closed-auditoria-tabelas-desprotegidas | `09-rls-fail-closed-auditoria-tabelas-desprotegidas.md` |
| 10 | sandbox-nivel-2-container-modo-isolado | `10-sandbox-nivel-2-container-modo-isolado.md` |
...
| 6 | jwt-hardening-segredo-prod-exp-obrigatorio | ⏳ Rascunho gerado, aguardando aprovacao | `06-jwt-hardening-segredo-prod-exp-obrigatorio.md` |
| 7 | hash-artefatos-skills-mcps-dependencias-externas | ⏳ Rascunho gerado, aguardando aprovacao | `07-hash-artefatos-skills-mcps-dependencias-externas.md` |
| 8 | mcp-defensivo-cap-limite-e-env-denylist | ⏳ Rascunho gerado, aguardando aprovacao | `08-mcp-defensivo-cap-limite-e-env-denylist.md` |
| 9 | rls-fail-closed-auditoria-tabelas-desprotegidas | ⏳ Rascunho gerado, aguardando aprovacao | `09-rls-fail-closed-auditoria-tabelas-desprotegidas.md` |
| 10 | sandbox-nivel-2-container-modo-isolado | ⏳ Rascunho gerado, aguardando aprovacao | `10-sandbox-nivel-2-container-modo-isolado.md` |
