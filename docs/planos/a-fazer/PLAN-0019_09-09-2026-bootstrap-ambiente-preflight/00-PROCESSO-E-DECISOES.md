...
| # | Item | Documento |
|---|---|---|
| 1 | self-healing-imports-python-ecossistema | `01-self-healing-imports-python-ecossistema.md` |
| 2 | preflight-host-diagnostico-binarios-sistema | `02-preflight-host-diagnostico-binarios-sistema.md` |
| 3 | tratamento-falhas-npx-bootstrap-skills | `03-tratamento-falhas-npx-bootstrap-skills.md` |
| 4 | bootstrapper-assistido-multi-os-fix | `04-bootstrapper-assistido-multi-os-fix.md` |
| 5 | campo-preflight-manifesto-dependencias-externas | `05-campo-preflight-manifesto-dependencias-externas.md` |
| 6 | unificar-detectores-binarios-nos-gates | `06-unificar-detectores-binarios-nos-gates.md` |
| 7 | preflight-ops-antecipado-ansible-sops-docker | `07-preflight-ops-antecipado-ansible-sops-docker.md` |
| 8 | atualizar-agents-md-bootstrap-preflight-sessao | `08-atualizar-agents-md-bootstrap-preflight-sessao.md` |
| 9 | sincronizacao-textual-quickstart-readme | `09-sincronizacao-textual-quickstart-readme.md` |
...
| 7 | preflight-ops-antecipado-ansible-sops-docker | ⏳ Rascunho gerado, aguardando aprovacao | `07-preflight-ops-antecipado-ansible-sops-docker.md` |
| 8 | atualizar-agents-md-bootstrap-preflight-sessao | ⏳ Rascunho gerado, aguardando aprovacao | `08-atualizar-agents-md-bootstrap-preflight-sessao.md` |
| 9 | sincronizacao-textual-quickstart-readme | ⏳ Rascunho gerado, aguardando aprovacao | `09-sincronizacao-textual-quickstart-readme.md` |
