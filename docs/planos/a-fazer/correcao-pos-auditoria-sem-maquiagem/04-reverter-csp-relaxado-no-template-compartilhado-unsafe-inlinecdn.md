# Item 4 — Reverter CSP relaxado no template compartilhado (unsafe-inline/CDN)
...
```
Voce vai implementar o Item 4: Reverter CSP relaxado no template compartilhado (unsafe-inline/CDN).
...
```
You are going to implement Item 4: Reverter CSP relaxado no template compartilhado (unsafe-inline/CDN).
