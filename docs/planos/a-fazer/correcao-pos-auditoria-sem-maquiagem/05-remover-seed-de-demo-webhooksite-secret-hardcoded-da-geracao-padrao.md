# Item 5 — Remover seed de demo (webhook.site + secret hardcoded) da geracao padrao
...
```
Voce vai implementar o Item 5: Remover seed de demo (webhook.site + secret hardcoded) da geracao padrao.
...
```
You are going to implement Item 5: Remover seed de demo (webhook.site + secret hardcoded) da geracao padrao.
