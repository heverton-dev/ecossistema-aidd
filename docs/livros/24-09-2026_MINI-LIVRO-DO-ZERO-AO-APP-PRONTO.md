...
abstract: |
  ...
  **Ecossistema AIDD**, cobrindo cada etapa desde o acesso inicial ao repositório monorepo até
  ...
  50 Quality Gates globais e o Quarteto Sine Qua Non exigido pela Lei #10).
---
...
## Na Casa
Esse é o papel do motor `vsa_join_barrier.py` e dos **50 Quality Gates** globais do ecossistema.
...
- **A Auditoria de Portões:**
  Antes de selar o commit, o comando `python ecossistema.py audit` roda os 40 guardas registrados no `pre-commit` (os outros 10 rodam sob demanda):
  - `G_TESTES_REAIS`: Roda de verdade o `pytest` de cada uma das 8 ferramentas (2.343 testes coletados em 24/09/2026).
...
# 13. Resumo das Palavras Mágicas
