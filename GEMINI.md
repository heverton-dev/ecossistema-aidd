...
- Execute a skill (`freedom`, `pure`, `aidd-open`, `open`, `aidd-bridge-runner`, `aidd-pipeline-runner`, `aidd-dispatch-runner`, `aidd-auditor-4f-runner`, `aidd-evolucao-runner`, `aidd-sessao`) ou o CLI (`python ecossistema.py freedom|pure|open|bridge|run-plan|pipeline|dispatch|audit-4f|evolucao|sessao <args>`).
