...
5. **Isolamento em Testes:** Qualquer teste ou validação estrutural deve ser executado em diretório temporário isolado, jamais alterando ou criando lixo em `docs/planos/` em tempo de teste.
